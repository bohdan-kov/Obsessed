...
import PlanExerciseItem from '@/pages/workouts/components/plans/PlanExerciseItem.vue'
    ...
    <SheetContent side="right" class="w-full sm:max-w-2xl flex flex-col p-0">
      ...
      <SheetFooter class="px-6 py-4 border-t flex-row gap-2 sm:gap-2">
        ...
        >
          ...
          {{ saving ? (mode === 'create' ? t('plans.form.creating') : t('plans.form.updating')) : t('plans.form.save') }}
        </Button>
      </SheetFooter>
    </SheetContent>
